...
def add_to_cart(request, product_id):
    ...
    redirect_url = request.META.get('HTTP_REFERER', reverse('shop:product_detail', args=[product.id, product.slug]))
...
def checkout(request):
    ...
    return render(request, 'cart/checkout.html', {
        'cart': cart,
        'total_price': cart.get_total_price  # Передаем как свойство
    })